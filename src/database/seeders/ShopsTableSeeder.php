...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        [
            [
                'name' => '仙人',
                'image_path' => 'https://teeth-aws-bucket.s3.ap-northeast-1.amazonaws.com/sushi.jpg',
                'prefecture_id' => 1,
                'genre_id' => 2,
            ...
            [
                'name' => '牛助',
                'image_path' => 'https://teeth-aws-bucket.s3.ap-northeast-1.amazonaws.com/yakiniku.jpg',
                'prefecture_id' => 2,
                'genre_id' => 1,
            ...
            [
                'name' => '戦慄',
                'image_path' => 'https://teeth-aws-bucket.s3.ap-northeast-1.amazonaws.com/izakaya.jpg',
                'prefecture_id' => 3,
                'genre_id' => 3,
            ...
            [
                'name' => 'ルーク',
                'image_path' => 'https://teeth-aws-bucket.s3.ap-northeast-1.amazonaws.com/italian.jpg',
                'prefecture_id' => 1,
                'genre_id' => 4,
            ...
            [
                'name' => '志摩屋',
                'image_path' => 'https://teeth-aws-bucket.s3.ap-northeast-1.amazonaws.com/ramen.jpg',
                'prefecture_id' => 3,
                'genre_id' => 5,
